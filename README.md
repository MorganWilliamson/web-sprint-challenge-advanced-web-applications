...
Tokens are unique identifiers that are used for authorization, determining what a given user has access to on the site/in the application. 

2. What steps can you take in your web apps to keep your data secure?
Establishing private routes and utilizing tokens are a great start. Further layers of encryption and security can be added to protect data input by a user.  

3. Describe how web servers work.
Web servers store the content of a website, and deliver the information to a user's browser upon request through HTTP. They are external from a user's device. 
